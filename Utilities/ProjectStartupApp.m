classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Probability-Theory";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Position = [8 360 259 59];
            app.WelcomeTitle.Text = 'Fundamentals of Probability Theory';
            ...
            app.Image.ImageSource = 'bayesTheorem.png';
            ...
            app.ReviewTitle.Position = [8 321 259 89];
            app.ReviewTitle.Text = 'Welcome to Fundamentals of Probability Theory';
